...
<div class="col-12">
    ...
    <form action="{{route('dashboard.products.index.store')}}" method="post" enctype="multipart/form-data">
        @csrf

        <div class="row">
            <div class="col-6 mb-3" >
                <label for="name_en">Name En</label>
                <input type="text" class="form-control" name="name_en" placeholder="Enter Name En">
                @error('name_en')
            ...
            <div class="col-6 mb-3">
                ...
                <input type="text" class="form-control" name="name_ar" placeholder="Enter Name ar">
                @error('name_ar')
                <div class="text-danger">{{$message}}</div>
                @enderror
            </div>
